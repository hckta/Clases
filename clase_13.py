...
class Alumno():
    ...
    def resultado(self,nombre, nota):
        super().__init__ = nombre
        super().__init__= nota
        if nota > 5:
            print (f'El alumno {nombre} esta aprobado!, felicidades.')
        elif nota < 5:
            print (f'El alumno {nombre} esta desaprobado, lo siento')
        elif nota == 5:
            print (f'El alumno {nombre} podra rendir recuperatorio')
            
    def imprimir(self, nombre, nota):
        super ().__init__ = nombre
        super().__init__ = nota
    print(f'El alumno {nombre} obtuvo la calificacion de {nota}')
        
            
Alumno1 = Alumno('Pepito', 4)
Alumno2 = Alumno('Felipe', 8)
Alumno3 = Alumno('Sebastian', 10)
Alumno4 = Alumno('Pablito', 5)
...
print(Alumno2.resultado('Felipe', 8))
print(Alumno3.resultado('Sebastian', 10))
print(Alumno4.resultado('Pablito', 5))

print(Alumno1.imprimir('Pepito', 4))