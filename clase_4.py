...
# if (preferencia == "marvel" and nombre
...
ingreso = int(input('Ingrse su salario: '))

if edad > 18 and antiguedad >= 3 and ingreso >= 2500:
   print('Tu credito esta aprobado!')
elif edad > 18 and antiguedad <= 3 and ingreso >= 4000:
   print('Tu credito esta aprobado!')
else:
   print('Tu credito no esta aprobado')