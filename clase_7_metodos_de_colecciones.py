...
# divisa = input('Ingrese la divisa solicitada: ').lower()
# if divisa == 'dolar':
#  print('se han retirado dolares $')
# elif divisa == 'euro':
#  print('se han retirado euros €')
# elif divisa == 'libra':
#  print('se han retirado libras £')
# else:
#  print('la dvisa seleccionada no se encuentra disponible')

# pregunta = input('Ingrese la divisa solicitada: ')
# if pregunta == 'euro' or 'dolar' or 'libra':
#  print('cande te amo mucho')
# else:
#  print('cande te amo')
...
# 1# print(lista_sin_duplicados)
# 2# lista_sin_duplicados.sort(reverse=True)
# sin_impares = []
