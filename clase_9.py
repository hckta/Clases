...
#     else: 
#      return 'impar'
# print(par_o_impar(int(input( 'Ingrese un numero: '))))

# DESAFIO PAR O IMPAR REALIZADO
# def par_o_impar(numero):
#     for caracter in numero:
#         if caracter not in '123456789':
#             return 'Ingrese unicamente un numero'
#     numero_casteado = int(numero)
#     if numero_casteado %2 == 0: 
#         return 'El numero es PAR'
#     else: 
#         return 'El numeo es IMPAR'
        
# print(par_o_impar(input('Ingrese un numero de una vez: ')))
...
# DESAFIO ANIO BISESTO

def anio_bisiesto(anio):
    for caracter in anio:
         if caracter not in '0123456789':
            return 'Error ingrese un año.'
        
    anio_casteado = int(anio)
    
    if anio_casteado % 4 == 0 and (anio_casteado % 100 != 0 or anio_casteado % 400 == 0):
        return 'El año es bisiesto '
    else: return 'El no año es bisiesto'
